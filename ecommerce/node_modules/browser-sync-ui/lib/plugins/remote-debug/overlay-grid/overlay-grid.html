<div ng-show="ctrl.overlayGrid.active" bs-panel-content>
	...
	<div bs-inputs bs-grid="wide-4 desk-2">
		<div bs-grid-item>
			<div bs-input="text">
				...
				<div bs-input>
					<input type="text" max="100" min="0" step="1" id="grid-size"
						size="20" ng-change="ctrl.alter(ctrl.overlayGrid)"
		...
		<div bs-grid-item>
			<div bs-input="text">
				...
				<div bs-input>
					<input type="text" max="100" min="0" step="1" id="grid-color"
						size="20" ng-change="ctrl.alter(ctrl.overlayGrid)"
		...
		<div bs-grid-item>
			<div bs-input="text">
				...
				<div bs-input>
					<input type="text" max="100" min="0" step="1" id="grid-selector"
						size="20" ng-change="ctrl.alter(ctrl.overlayGrid)"
	...
	<div bs-inputs bs-grid="wide-4 desk-2">
		<div bs-grid-item>
			<div bs-input="text">
				...
				<div bs-input>
					<input type="text" id="grid-offsetY" size="20"
		...
		<div bs-grid-item>
			<div bs-input="text">
				...
				<div bs-input>
					<input type="text" id="grid-offsetX" size="20"
						ng-change="ctrl.alter(ctrl.overlayGrid)"
	...
	<div bs-inputs bs-grid="wide-4 desk-2">
		<div bs-grid-item>
			<div bs-input="inline">
				<input type="checkbox" id="grid-axis-y"
		...
		<div bs-grid-item>
			<div bs-input="inline">
				<input type="checkbox" id="grid-axis-x"
