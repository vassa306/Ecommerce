...
<section ng-if="!ctrl.ui.plugins.length">
	<div bs-panel>
		<div bs-panel-content="basic">
			...
			<p>
				You can either write your own plugin (guide coming soon!) or <a
					href="https://www.npmjs.org/search?q=browser%20sync%20plugin"
					target="_blank">Search NPM</a> for packages that contain the
				keywords
				<code>browser sync plugin</code>
			</p>
		</div>
	</div>
</section>