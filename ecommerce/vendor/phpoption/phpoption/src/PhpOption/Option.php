...
abstract class Option implements IteratorAggregate
{
     ...
     * @param S $noneValue
     *            The value which should be considered "None"; null by
     *            default.
     *            
     * @return Option<S>
     */
     ...
     * @param S $noneValue
     *            The value which should be considered "None";
     *            null by default.
     *            
     * @return LazyOption<S>
     */
    ...
    public static function lift($callback, $noneValue = null)
    {
        return static function () use ($callback, $noneValue) {
            ...
            $reduced_args = array_reduce($args, /**
             *
             * @param bool $status
             */
