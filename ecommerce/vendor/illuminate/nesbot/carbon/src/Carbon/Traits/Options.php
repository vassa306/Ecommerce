...
trait Options
{
     ...
     * @see settings Enable the strict mode (or disable with passing false).
     *     
     ...
     * @see settings Indicates if months should be calculated with overflow.
     *     
     ...
     *             Or you can use method variants: addMonthsWithOverflow/addMonthsNoOverflow, same variants
     *             are available for quarters, years, decade, centuries, millennia (singular and plural forms).
     * @see settings Reset the month overflow behavior.
     *     
     * @return void
     */
     ...
     *             are available for quarters, years, decade, centuries, millennia (singular and plural forms).
     * @see settings Indicates if years should be calculated with overflow.
     *     
