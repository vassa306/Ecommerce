 ...
 * @property int $year Depends on the following methods:
 *          
...
trait Week
{
     ...
     * day of year included in the first week.
     * Or use ISO format if no settings
     * given.
     *
     * @param int|null $year
     ...
     * Set/get the week number of year using given first day of week and first
     * day of year included in the first week.
     * Or use US format if no settings
     * given (Sunday / Jan 6).
     *
     * @param int|null $year
     *            if null, act as a getter, if not null, set the year and return current instance.
    ...
    public function weekYear($year = null, $dayOfWeek = null, $dayOfYear = null)
    {
        ...
        if ($year !== null) {
            ...
            $date = $date->addWeeks($week - $date->week(null, $dayOfWeek, $dayOfYear))
