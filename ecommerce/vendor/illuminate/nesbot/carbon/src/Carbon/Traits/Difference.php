...
trait Difference
{
    ...
    public function diffFiltered(CarbonInterval $ci, Closure $callback, $date = null, $absolute = true)
    {
        ...
        $diff = $ci->toPeriod($start, $end, $options)
            ->filter($callback)
            ->count();
    ...
    public function floatDiffInMonths($date = null, $absolute = true)
    {
        ...
        $startOfMonthAfterFloorEnd = $floorEnd->copy()
            ->addMonth()
            ->startOfMonth();
    ...
    public function floatDiffInYears($date = null, $absolute = true)
    {
        ...
        $startOfYearAfterFloorEnd = $floorEnd->copy()
            ->addYear()
            ->startOfYear();
     ...
     *          ```
     *         
     * @param Carbon|\DateTimeInterface|string|array|null $other
    ...
    /**
     * Returns either day of week + time (e.g.
     * "Last Friday at 3:30 PM") if reference time is within 7 days,
