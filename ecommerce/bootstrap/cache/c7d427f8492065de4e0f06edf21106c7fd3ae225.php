							...
							<td width="100" class="text-right"><span data-tooltip
								...
								data-disable-hover="false" tabindex="1" title="Edit SubCategory">
									...
									title="Delete SubCategory">
										<form method="post"
											action="/admin/products/subcategory/<?php echo e($subcategory['id']); ?>/delete"
											class="delete-item">
											<input type="hidden" name="token"
												value="<?php echo e(\app\classes\CSRFToken::_token()); ?>">
											<button type="submit">
...
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/admin/products/categories.blade.php ENDPATH**/ ?>